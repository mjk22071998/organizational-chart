...
OrgChart._defaultConfig = function(t) {
            ...
            v = function(e) {
                if (p) {
                    ...
                    if (s.left || s.right || s.up || s.down) {
                        ...
                        for (o.stopMove(), g.classList && (g.classList.add("boc-cursor-grab"), g.classList.remove("boc-cursor-move"), g.classList.remove("boc-cursor-nodrop"), g.classList.remove("boc-cursor-copy")), O(d, c), d = null, c = null; null != i && i != g;) {
        ...
        for (var d = 0; d < e.roots.length; d++) {
            ...
            if (c) {
                for (var u = !1, f = 0; f < s.length; f++)
                    ...
                    if (!OrgChart.isNEU(c.pid))(z = (O = l[c.pid]).childrenIds.indexOf(c.id)) > -1 && O.childrenIds.splice(z, 1);
                    s.push(c)
                }
            }
        }
    ...
    if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
        for (d = 0; d < e.expand.nodes.length; d++) {
            ...
            for (d = 0; d < b.length; d++)
                for (var O = l[(C = l[b[d]]).pid]; O;) m.push(O.id), null == O.pid && null != O.stpid ? (O = l[O.stpid]).min = !1 : O = l[O.pid]
    ...
    var _ = [],
        ...
        S = {},
        I = [];
    for (d = 0; d < s.length; d++) OrgChart.manager._iterate(s[d], s[d], l, 0, _, w, k, S, "", m, I, t);
    ...
    for (d = 0; d < I.length; d++) {
        ...
        for (x = 0; x < E.length; x++) {
            ...
            for (var R = 0; R < D.childrenIds.length; R++) H.push(D.childrenIds[R])
        }
        var F = [];
        for (x = 0; x < L.length; x++) {
            N[(D = l[L[x]]).id] ? C.children.push(D) : C.children.splice(0, 0, D);
            for (R = 0; R < D.childrenIds.length; R++) F.push(D.childrenIds[R])
        }
        for (x = 0; x < F.length; x++) {
            (D = l[F[x]]).collapsed || (D.parentPartner = D.parent, D.parent = C, D.isChildOfPartner = !0, C.children.push(D))
        }
        for (x = L.length - 1; x >= 0; x--)
            if (N[L[x]])
                for (f = 0; f < N[L[x]].length; f++) C.children.push(l[N[L[x]][f]]), T++, -1 == U.indexOf(L[x]) && U.push(L[x]);
        ...
        for (x = 0; x < E.length; x++)
            if (N[E[x]])
                for (f = 0; f < N[E[x]].length; f++) C.children.push(l[N[E[x]][f]]), B++, -1 == P.indexOf(E[x]) && P.push(E[x]);
        for (x = 0; x < H.length; x++) {
            (D = l[H[x]]).collapsed || (D.parentPartner = D.parent, D.parent = C, D.isChildOfPartner = !0, C.children.push(D))
        }
    ...
    for (d = 0; d < k.length; d++) {
        if ((at = r[(C = l[k[d]]).lcn ? C.lcn : "base"]).layout == OrgChart.normal || !S[C.pid])
            for (x = 0; x < C.subLevels; x++) {
                ...
                if (OrgChart.manager._initDinamicNode(j, C.lcn), O = C.parent)(z = O.children.indexOf(C)) > -1 && (O.children.splice(z, 1), O.children.splice(z, 0, j)), j.children.push(C), j.parent = O, C.parent = j, l[j.id] = j
            }
    }
    for (var Y in w) {
        ...
        for (x = q.length - 1; x >= 0; x--)
            if (x % 2 && x != q.length - 1) {
                ...
                OrgChart.manager._initDinamicNode(G, O.lcn, !0), l[G.id] = G, q.splice(x, 0, G.id), V++
            } else x % 2 && q.splice(x, 0, j.id);
        ...
        for (var Y in S) {
            ...
            if ((at = r[O.lcn ? O.lcn : "base"]).layout == OrgChart.mixed || at.layout == OrgChart.tree || at.layout == OrgChart.treeRightOffset || at.layout == OrgChart.treeLeftOffset || et)
                ...
                for (d = rt.childrenIds.length - 1; d >= 0; d--) {
                    for (D = l[rt.childrenIds[d]], x = 0; x < O.children.length; x++) O.children[x].id == D.id && O.children.splice(x, 1);
    ...
    node: function(t, e, r, i, a, n, o, l, s, h) {
        ...
        for (var p in o) {
            ...
            if (g.value = u, g.element = d[p], g.name = f, !1 !== OrgChart.events.publish("field", [h, g]) && null != g.value && null != g.value && null != g.element) {
        ...
        if (e.sl == n.sl) switch (h = n, g.orientation) {
            ...
            for (var m = e; null == h;) {
                var C = !1,
                    ...
                    O = b.leftNeighbor,
                    v = b.rightNeighbor;
                if (b.id == n.id ? h = b : OrgChart._intersects(b, f, t.config) && (f = OrgChart._addPoint(b, s, t.config, f, d), C = !0), b.id != n.id) {
                    for (; O;) {
                        if (O.id == n.id) {
                            h = O;
                            break
                        }
                        OrgChart._intersects(O, f, t.config) && (f = OrgChart._addPoint(O, s, t.config, f, d), C = !0), O = O.leftNeighbor
                    }
                    for (; v;) {
                        if (v.id == n.id) {
                            h = v;
                        ...
                        OrgChart._intersects(v, f, t.config) && (f = OrgChart._addPoint(v, s, t.config, f, d), C = !0), v = v.rightNeighbor
                    }
                }
                if (!C) {
